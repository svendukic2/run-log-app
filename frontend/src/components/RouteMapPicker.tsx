...
// Mirrors --color-route / --color-success / --color-accent in globals.css.
// Leaflet options take colours as values, not classes, so these are the one
// place the hexes are repeated; the tokens are the source of truth.
const ROUTE_LINE_COLOR = '#2f6fdb';
